        ...
        function SocialNetWorks() {
            ...
            $this->networks =
                ['Google'=>['available'=>$this->adnbp->getConf('GoogleOauth') && strlen($this->adnbp->getConf('GoogleOauth_CLIENT_ID')) && strlen($this->adnbp->getConf('GoogleOauth_CLIENT_SECRET'))
                    ...
                    'Instagram'=>['available'=>$this->adnbp->getConf('InstagramOauth') && strlen($this->adnbp->getConf('InstagramOauth_CLIENT_ID')) && strlen($this->adnbp->getConf('InstagramOauth_CLIENT_SECRET'))
